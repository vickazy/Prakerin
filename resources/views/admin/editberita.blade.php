		...
		<div class="col-md-8 col-md-offset-2">
			<div class="panel panel-default">
				...
				<div class="panel-body">
						...
						{!! Form::model($berita, ['method' => 'PATCH', 'route' => ['tambahberita.update', $berita->id],'class' => 'form-horizontal','files' => true]) !!}
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								{!! Form::select('id_kategori', $kategori, $berita->id_kategori) !!}
							</div>
						</div>
